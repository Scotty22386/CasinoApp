...
import 'package:casino_games/card_column.dart';
import 'package:casino_games/empty_card.dart';
import 'package:casino_games/playing_card.dart';
import 'package:casino_games/transformed_card.dart';
import 'main.dart';

//Modified by Scott Wickline
//Card Game by Devon 98
...
class _GameScreenState extends State<GameScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Casino Games Solitaire"),
        elevation: 0.0,
        backgroundColor: Colors.green,
        actions: <Widget>[
          InkWell(
